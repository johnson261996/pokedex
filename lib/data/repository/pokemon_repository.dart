...
class PokemonRepository {
  ...
  Future<PokemonListResponse> getPokemonList({int limit = 100, int offset = 0,String query = ""}) {
    return _provider.fetchPokemonList(limit: limit, offset: offset,query:query);
  }
